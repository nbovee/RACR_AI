...
# python3 -m grpc_tools.protoc -I./ColabVision/protos --python_out=./ColabVision/src/colab_vision_pb2 --grpc_python_out=./ColabVision/src ./ColabVision/protos/colab_vision.proto