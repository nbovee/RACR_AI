        ...
        for file in files:
            ...
            with open(output_file, "w") as f:
                for obj in root.findall('object'):
                    cls_name = "_".join(obj.find('name').text.strip().lower().split(" "))
                    ...
                    f.write(f"{classification_label[cls_name]} {x_center} {y_center} {width} {height}\n")

    def _arrange_files(self, files_location, images_location, annotations_location, target_location):
